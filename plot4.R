...
#Plot 4
png(filename="/Users/thientrangbui/Dropbox/Cousera Machine learning/Exploratory data analysis/project 1/plot4.png",width = 480, height = 480)
...
with(data_sub, {
  ...
  plot(data_sub$Global_reactive_power~data_sub$Datetime, type="l", 
